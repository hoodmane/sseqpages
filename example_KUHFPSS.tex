...
\begin{document}
\tikzset{
    Z2class/.style={circle,inner sep=0.3ex,fill=black},
    Zclass/.style={fill=none,draw,inner sep=0.6ex},
    2Zclass/.style={fill=none,rectangle,draw,inner sep=0.6ex,outer sep=0.5ex}
}
\begin{sseqdata}[
    name=KRHFPSS,
    x range={-12}{14},
...
\pgfmathsetmacro\xitstart{int(\xmin/8)*8-16}
\pgfmathsetmacro\xitgap{\xitstart+4}
\pgfmathsetmacro\xitend{\xmax+2}
\pgfmathsetmacro\xmaxpp{\xmax+2}
...
\pgfmathsetmacro\xitstart{\xitgap}
\pgfmathsetmacro\xitgap{\xitstart+8}
