...
%
% TODO:
% \structline, \structlineoptions page keys
%
% Title page
...
\pgfkeys{/sseqpages/class/struct line:page/.forward to=/sseqpages/struct line/page}
\begin{document}
...
\begin{keylist}{run off=\marg{start arrow}\marg{end arrow}, 
    run off struct lines=\marg{start arrow}\marg{end arrow}  (initially {...-...}),
    run off differentials=\marg{start arrow}\marg{end arrow} (initially {...-...})}
